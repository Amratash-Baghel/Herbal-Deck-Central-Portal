/**
 * Lightweight inline icon set (no icon-library dependency). Each accepts a
 * className for sizing/coloring and inherits the current text color.
 */
...
export function BillingIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      <path d="M5 3h14v18l-3-2-2 2-2-2-2 2-2-2-1 2V3Z" />
...
export function KeyIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="m10.7 12.3 9.3-9.3M16 6l3 3M18 4l3 3" />
    </svg>
  );
}
...
/** Google Drive brand mark (its own colours, not currentColor). */
...
export function DropboxIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        fill="#0061FF"
        d="M6 1.807 0 5.629l6 3.822 6-3.822zm12 0-6 3.822 6 3.822 6-3.822zM0 13.274l6 3.822 6-3.822-6-3.822zm18-3.822-6 3.822 6 3.822 6-3.822zM6 18.371l6 3.822 6-3.822-6-3.821z"
      />
    </svg>
  );
}
